...
?>
  ...
  ?>
    ...
    <div class=myUpdate>
        ...
        <label style="padding-right:50px;">Total Price:</label>
        <label><?=$row['OPA_TotalPrice'];?></label><br> 
        <label style="padding-right:50px;">Pet Image:</label>
        <img src="<?=$row['Pet_Image'];?>" style="width: 40%;height: 200px;margin-left: 12px; margin-top: 20px;">
    <div>
      <input type="button" onclick="location.href='/RRMS/ApplicationLayer/ManagePetAssistInterface/spBookingsAll.php'" value="Back" style="float: right; margin-right: 10px" class="w3-circle w3-button w3-black">
    </div><br>
    </form>
  </div>
  </div>
